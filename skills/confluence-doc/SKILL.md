...
- **Quality judgment:** upstream design and design review (the `software-design-review` skill) own checks for unresolved decisions, uncovered requirements, and missing failure modes. Do not judge them here; transfer upstream annotations **unchanged**.
