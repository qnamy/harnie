...
> **v0.12.2** · 테스트 304 pass / 0 fail (`node --test scripts/*.test.mjs hooks/*.test.mjs`) · GitHub 공개, 마켓플레이스 설치 · 0.12는 난이도 4등급화(very hard 신설) + 재판정 체크포인트 + dev-solo Codex 셀프리뷰 전환
